...
// Check if the pageWrapper has compact-wrapper class and the target element exists
if ($("#pageWrapper").hasClass("compact-wrapper")) {
  var $activeLink = $(".simplebar-wrapper .simplebar-content-wrapper a.active");

  // Ensure the active link exists and has been rendered
  if ($activeLink.length) {
    var scrollTopValue = $activeLink.offset().top - 400;
