        ...
        <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
            <div> <a class="toggle-sidebar" href="#"> <i class="iconly-Category icli"> </i></a>
                <div class="d-flex align-items-center gap-2 ">
                    <h4 class="f-w-600">Bem vindo <?= htmlspecialchars($_SESSION['user']['apelido']); ?></h4><img class="mt-0" src="../assets/images/hand.gif" alt="hand-gif">
                </div>
            </div>
                    ...
                    <div class="onhover-show-div bookmark-flip">
                        <div class="flip-card">
                            <div class="flip-card-inner">
                                <div class="front">
                                    <h6 class="f-18 mb-0 dropdown-title">Atalhos Rápidos</h6>
                                            ...
                                            <div class="cart-dropdown mt-4">
                                                <ul>
                                                    ...
                                                    <li class="mb-3 total"><a href="../template/checkout.html">
                                                            <h6 class="mb-0">
                                                                Order Total :<span class="f-right">$1195.00 </span></h6>
                                                        </a></li>
                                                </ul>
                                            </div>
                                        </div>
                ...
                <li class="profile-nav onhover-dropdown">
                    <div class="media profile-media"><img class="b-r-10" src="../assets/images/dashboard/profile.png" alt="">
                        <div class="media-body d-xxl-block d-none box-col-none">
                            <div class="d-flex align-items-center gap-2">
                                <span>
                                    <?= htmlspecialchars($_SESSION['user']['apelido']); ?>
                                </span>
                                <i class="middle fa fa-angle-down"></i>
                            </div>

                            <p class="mb-0 font-roboto"><?= htmlspecialchars($_SESSION['user']['posicao']); ?></p>
                        </div>
                    </div>
                    <ul class="profile-dropdown onhover-show-div">
                        <li><a href="perfil.php"><i data-feather="user"></i><span>Meu Perfil</span></a></li>
                        <li><a href="#"><i data-feather="mail"></i><span>Inbox</span></a></li>
                        <li> <a href="#"> <i data-feather="settings"></i><span>Configurações</span></a></li>
                        <li class="text-center"><a class="btn btn-pill btn-outline-primary btn-sm text-center" href="logout.php">Sair</a></li>
                    </ul>
                </li>
            </ul>
        </div>
