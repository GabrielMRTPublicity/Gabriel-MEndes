<div class="sidebar-wrapper" data-layout="stroke-svg">
    <div class="logo-wrapper">
        <a href="index.php">
            <img style="max-width: 150px;" class="img-fluid" src="../assets/images/logo/logo.png" alt="">
        </a>
        ...
        <div id="sidebar-menu">
            <ul class="sidebar-links" id="simple-bar">
                ...
                <li class="pin-title sidebar-main-title">
                    <div>
                        <h6>Navegação Fixa</h6>
                    </div>
                </li>
                <li class="sidebar-main-title">
                    <div>
                        <h6 class="lan-1">Principal</h6>
                    </div>
                </li>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                        ...
                        </svg><span class="lan-10">Eventos</span></a>
                    <ul class="sidebar-submenu">
                        
                        <li><a href="eventos_publicados.php">Publicados</a></li>
                        <li><a href="cadastrar_eventos.php">Cadastrar</a></li>
                    </ul>
                </li>
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                        <svg class="stroke-icon">
                        ...
                        </svg><span class="lan-11">Instituições</span></a>
                    <ul class="sidebar-submenu">
                        <li><a href="instituicoes_publicadas">Publicadas</a></li>
                        <li><a href="cadastrar_instituicoes.php">Cadastrar</a></li>
                    </ul>
                </li>
                <li class="sidebar-list"> <i class="fa fa-thumb-tack"> </i><a class="sidebar-link sidebar-title" href="#">
                        <svg class="stroke-icon">
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="../starter-kit/index.php" target="_blank">
                        <svg class="stroke-icon">
