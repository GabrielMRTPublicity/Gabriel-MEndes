...
<head>
    ...
    <title>Instituições | Atitude Turismo</title>
    <!-- Google font-->
    ...
    <style type="text/css">
        ...
        #popupDetalhesEventos, #popupEdicaoInstituicao{
            width: 90%; 
        }
        .divforaTable{
        ...
        .popupEditarIMG .swal2-html-container,.popupEditarPDF .swal2-html-container,#popupEdicaoInstituicao .swal2-html-container{
...
<body class="light">
            ...
            <div class="page-body">
                <div class="container-fluid">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-6">
                                <h4 id="tituloPagina">Lista de Instituições</h4>
                            </div>
                            <div class="col-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Publicadas</li>
                                </ol>
                            </div>
                        </div>
                    </div>
    ...
    <script src="../assets/js/pages/instituicoes-publicadas.js"></script>
